...
exports.addEstate = async (req, res, next) => {
  ...
  if (fetch.data.features[0] && fetch.data.features[0].geometry.coordinates[0])
    lng = fetch.data.features[0].geometry.coordinates[0];
  if (fetch.data.features[0] && fetch.data.features[0].geometry.coordinates[1])
    lat = fetch.data.features[0].geometry.coordinates[1];
